...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  // sentences
  var addSentence = `${a} and ${b} and ${c} sum to ${num2}.`;
  var multiplySentence = `The product of ${a} and ${b} and ${c} is ${num4}.`;
  // return
  return [num2, num4, addSentence, multiplySentence];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var num1 = multiply(multArr[0], multArr[1])[0];
  var num2 = multiply(num1, multArr[2])[0];
  console.log(num2);
  var sentence = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${num2}.`;
  return [num2, sentence];
